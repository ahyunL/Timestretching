# -*- coding: utf-8 -*-
"""UROP_TimeStretch(원본+0.7)_small수정1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1B7m21i3yXOXdRp4cCCo7z-RHvwgFRyub
"""
...
# 원본 + 0.7배 속도 증강 샘플 1:1
proc_train_sp09 = augment_copy(train_raw_16k, 0.7)
...
args = Seq2SeqTrainingArguments(
    output_dir="./whisper-small-mix_0p7",
...
print("[sanity] before train:", trainer_mix07.state.global_step)
trainer_mix07.train()
print("[sanity] after  train:", trainer_mix07.state.global_step)
...
display(df_orig)
df_orig.to_csv("/content/results_mix0p7_test_orig_ONLY.csv", index=False)
print("Saved -> /content/results_mix0p7_test_orig_ONLY.csv")
...
bar_lang(df_orig, "Original Test (mix 0.7)")