# -*- coding: utf-8 -*-
"""UROP_TimeStretch(원본+0.7).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14jhNyTK0qFN2fjb7ChVAXL1LzeOAgJGZ
"""
...
args = Seq2SeqTrainingArguments(
    output_dir="./whisper-tiny-mix_0p7",   # ← CHANGED
...
df_orig = eval_on(proc_test_orig, trainer_mix07, "test_orig")  # ← CHANGED
...
proc_test_r07 = make_processed_with_rate(test_raw_16k, 0.7)   # ← CHANGED
df_r07   = eval_on(proc_test_r07, trainer_mix07, "test_rate0.7")  # ← CHANGED

display(df_orig, df_r07)
df_all = pd.concat([df_orig, df_r07], ignore_index=True)
df_all.to_csv("/content/results_mix0p7_test_orig_and_r07.csv", index=False)  # ← CHANGED
print("Saved -> /content/results_mix0p7_test_orig_and_r07.csv")              # ← CHANGED
