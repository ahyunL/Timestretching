# -*- coding: utf-8 -*-
"""UROP_TimeStretch(원본+1.3).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1AenLwOxgdWmyniU7JDbCt7Sv8d9q8N6Y
"""
...
m = min(len(proc_train_sp13), k)  # 사용할 증강 샘플 수
...
args = Seq2SeqTrainingArguments(
    output_dir="./whisper-tiny-mix_1p3",   # ← 변경
...
df_orig = eval_on(proc_test_orig, trainer_mix13, "test_orig")

# (B) 1.3배로 변형된 test 생성 → 평가 (robustness 참고용)
...
proc_test_r13 = make_processed_with_rate(test_raw_16k, 1.3)
df_r13   = eval_on(proc_test_r13, trainer_mix13, "test_rate1.3")

display(df_orig, df_r13)
df_all = pd.concat([df_orig, df_r13], ignore_index=True)
df_all.to_csv("/content/results_mix1p3_test_orig_and_r13.csv", index=False)
print("Saved -> /content/results_mix1p3_test_orig_and_r13.csv")
...
print("training on:", trainer_mix13.args.output_dir)

# 반드시 train_dataset가 proc_train_mix 인지 확인
assert trainer_mix13.train_dataset is proc_train_mix
# 검증은 원본만 쓰는지 확인
assert trainer_mix13.eval_dataset is proc_val_orig
