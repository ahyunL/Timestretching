# -*- coding: utf-8 -*-
"""UROP_TimeStretch(원본+1.1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1JWBffGurQqFjC7-IP5Pvf4_T_xRODnJL
"""
...
m = min(len(proc_train_sp11), k)  # 사용할 증강 샘플 수
...
args = Seq2SeqTrainingArguments(
    output_dir="./whisper-tiny-mix_1p1",   # ← 변경
...
df_orig = eval_on(proc_test_orig, trainer_mix11, "test_orig")

# (B) 1.1배로 변형된 test 생성 → 평가 (robustness 참고용)
...
proc_test_r11 = make_processed_with_rate(test_raw_16k, 1.1)
df_r11   = eval_on(proc_test_r11, trainer_mix11, "test_rate1.1")

display(df_orig, df_r11)
df_all = pd.concat([df_orig, df_r11], ignore_index=True)
df_all.to_csv("/content/results_mix1p1_test_orig_and_r11.csv", index=False)
print("Saved -> /content/results_mix1p1_test_orig_and_r11.csv")
...
print("training on:", trainer_mix11.args.output_dir)

# 반드시 train_dataset가 proc_train_mix 인지 확인
assert trainer_mix11.train_dataset is proc_train_mix
# 검증은 원본만 쓰는지 확인
assert trainer_mix11.eval_dataset is proc_val_orig