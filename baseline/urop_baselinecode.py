# -*- coding: utf-8 -*-
"""UROP_baselinecode.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17BGHL5NISzsdzffWpszkQq7RWFrEwMp5
"""
...
display(df_base)
df_base.to_csv("/content/baseline_cv16_1_whisper_tiny.csv", index=False)
print("Saved -> /content/baseline_cv16_1_whisper_tiny.csv")
...
wer = [0.32, 0.28, 0.45, 0.41]   # 언어별 WER
cer = [0.21, 0.19, 0.29, 0.27]   # 언어별 CER
