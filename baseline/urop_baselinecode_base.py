# -*- coding: utf-8 -*-
"""UROP_baselinecode_base.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1KOm80alXK-7n3Vk2bIYh4RGmEdxX_lR8
"""
...
display(df_base)
df_base.to_csv("/content/baseline_cv16_1_whisper_base.csv", index=False)
print("Saved -> /content/baseline_cv16_1_whisper_base.csv")
...
wer = [0.38, 0.97, 0.27, 0.38]   # 언어별 WER
cer = [0.17, 0.56, 0.13, 0.15]   # 언어별 CER
